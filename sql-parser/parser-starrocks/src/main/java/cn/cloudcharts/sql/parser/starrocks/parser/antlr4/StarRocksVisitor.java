...
public interface StarRocksVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link StarRocksParser#useWarehouseStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUseWarehouseStatement(StarRocksParser.UseWarehouseStatementContext ctx);
	/**
